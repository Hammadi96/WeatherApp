    ...
    <View style={styles.container}>
      <View>
        ...
        <View style={styles.weatherItemContainer}>
          <WeatherItem title="Current Temp" value={current? current.temp : ""} unit="°"/>
          <WeatherItem title="Wind Speed" value={current? Math.round(current.wind_speed) : ""} unit="km/h"/>
